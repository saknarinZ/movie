...
export const SEAT: seatRow[] = [
  ...
  },
  {
    ...
    seats: [
      ...
      {id: 18, no: 3,status: 'IDLE'},
      {id: 19, no: 4,status: 'IDLE'},
      ...
      {id: 27, no: 12,status: 'IDLE'},
      {id: 28, no: 13,status: 'IDLE'},
      {id: 29, no: 14,status: 'IDLE'},
      {id: 30, no: 15,status: 'IDLE'}
    ]
  },
  {
    row: 'C',
    seats: [
      ...
      {id: 41, no: 11,status: 'IDLE'},
      {id: 42, no: 12,status: 'IDLE'},
  ...
  },
  {
    ...
    seats: [
      ...
      {id: 54, no: 9,status: 'IDLE'},
      {id: 55, no: 10,status: 'IDLE'},
  ...
  },
  {
    ...
    seats: [
      ...
      {id: 69, no: 9,status: 'IDLE'},
      {id: 70, no: 10,status: 'IDLE'},
  ...
  },
  {
    row: 'F',
    seats: [
      {id: 76, no: 1, status: 'IDLE'},
      {id: 77, no: 2,status: 'IDLE'},
      {id: 78, no: 3,status: 'IDLE'},
  ...
  },
  {
    row: 'G',
    seats: [
      {id: 91, no: 1, status: 'IDLE'},
      {id: 92, no: 2,status: 'IDLE'},
      {id: 93, no: 3,status: 'IDLE'},
      {id: 94, no: 4,status: 'IDLE'},
      {id: 95, no: 5,status: 'IDLE'},
      {id: 96, no: 6,status: 'IDLE'},
      {id: 97, no: 7,status: 'IDLE'},
      {id: 98, no: 8,status: 'IDLE'},
      {id: 99, no: 9,status: 'IDLE'},
      {id: 100, no: 10,status: 'IDLE'},
      {id: 101, no: 11,status: 'IDLE'},
      {id: 102, no: 12,status: 'IDLE'},
      {id: 103, no: 13,status: 'IDLE'},
      {id: 104, no: 14,status: 'IDLE'},
      {id: 105, no: 15,status: 'IDLE'}
    ]
  }
]
